...
-- The custom player mesh in this avatar is static, so use the vanilla player
-- as the animated body and keep only the wheelchair/cola custom geometry.
-- Weride emotes are applied to these vanilla parts by the client renderer.
