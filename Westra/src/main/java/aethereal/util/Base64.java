...
public class Base64 {
   ...
   private static final byte[] o = new byte[]{
      65,
      66,
      67,
      68,
   ...
   private static final byte[] r = new byte[]{
      -9,
      -9,
      -9,
      -9,
   ...
   static final boolean g = !Base64.class.desiredAssertionStatus();

   private static final byte[] b(int options) {
      if ((options & 16) == 16) {
         return o;
      } else {
         return (options & 32) == 32 ? q : m;
      }
   }

   public static final byte[] c(int options) {
      if ((options & 16) == 16) {
         return p;
      } else {
         return (options & 32) == 32 ? r : n;
      }
   }
      ...
      if (source == null) {
         ...
         try {
            try {
               ...
               b64os = new Base64.a(baos, 1 | options);
         ...
         for (int lineLength = 0; d2 < len2; e9 += 4) {
   ...
   public static int b(byte[] source, int srcOffset, byte[] destination, int destOffset, int options) {
      if (source == null) {
         ...
         if (source[srcOffset + 2] == 61) {
            ...
            int outBuff2 = (DECODABET[source[srcOffset]] & 255) << 18
               | (DECODABET[source[srcOffset + 1]] & 255) << 12
               | (DECODABET[source[srcOffset + 2]] & 255) << 6
