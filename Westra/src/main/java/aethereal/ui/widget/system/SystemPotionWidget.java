...
public class SystemPotionWidget extends SystemListWidget implements Interface {
   public SystemPotionWidget() {
      super("Зелья", "Potions");
   }
      ...
      if (aM_.field_1724 == null) {
         ...
         for (class_1293 effect : aM_.field_1724.method_6026()) {
            ...
            if (!(animation <= 0.0F)) {
               ...
               rows.add(new SystemListWidget.a(name, duration, harmful ? ColorUtil.a(255, 110, 110, 255) : -1, -1, animation));
            }
         }
