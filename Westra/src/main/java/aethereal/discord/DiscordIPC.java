...
public class DiscordIPC implements Closeable {
   ...
   public JsonObject a(Activity activity) throws IOException {
      Connection conn = this.j();
      JsonObject args = new JsonObject();
      args.addProperty("pid", ProcessIdUtil.a());
   ...
   private Connection j() {
      return Optional.ofNullable(this.c.o()).orElseThrow(() -> new ConnectionException("Not connected"));
   }
   ...
   private <T> CompletableFuture<T> a(DiscordIPC.a<T> supplier) {
