...
public final class InventoryPresetScreen extends Screen implements ru.prism.utils.annotation.IMinecraft {
    ...
    private final Map<String, ru.prism.utils.animation.satoshi.Animation> anims = new HashMap<>();
    ...
    public void render(DrawContext context, int rawMouseX, int rawMouseY, float delta) {
        ...
        for (InventoryPreset preset : presets) {
            ...
            ru.prism.utils.animation.satoshi.Animation activeAnim = anim("active:" + preset.name());
    ...
    private void drawInput(Font font, float x, float y, float w, float alpha) {
        ...
        ru.prism.utils.animation.satoshi.Animation focusAnim = anim("input:focus");
    ...
    private ru.prism.utils.animation.satoshi.Animation anim(String key) {
        return anims.computeIfAbsent(key, k -> new EaseInOutQuad(300, 1));
    }

    private float hoverAnim(String key, boolean hovered) {
        ru.prism.utils.animation.satoshi.Animation animation = anim(key + ":hover");
