...
import static ru.prism.screen.editor.EditorTheme.CHIP_H;
import static ru.prism.screen.editor.EditorTheme.CHIP_STEP;
import static ru.prism.screen.editor.EditorTheme.DELIMITER_H;
import static ru.prism.screen.editor.EditorTheme.HEADER_H;
import static ru.prism.screen.editor.EditorTheme.PANEL_PAD;
import static ru.prism.screen.editor.EditorTheme.PANEL_W;
import static ru.prism.screen.editor.EditorTheme.PICKER_H;
import static ru.prism.screen.editor.EditorTheme.ROW_GAP;
import static ru.prism.screen.editor.EditorTheme.ROW_H;
import static ru.prism.screen.editor.EditorTheme.SLIDER_H;
import static ru.prism.screen.editor.EditorTheme.TEXT;
import static ru.prism.screen.editor.EditorTheme.VALUE_TEXT;
