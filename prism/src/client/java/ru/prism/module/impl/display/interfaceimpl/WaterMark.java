...
public class WaterMark implements element {
    ...
    public void onRender(DragSetting dragSetting, InterFace interFace) {
        ...
        Fonts.prism_2.drawCentered("G",x  + H / 2,y + 5.1F * S,LOGO,ColorUtil.getClientColor(1));
        ...
        Fonts.prism_2.draw("N",x + ICON_X,y + ICON_Y,ICON,ColorUtil.getClientColor(1));
       ...
       float x2 = x + w + 2 * S;
        ...
        Fonts.prism_2.draw("C",x2 ,y + ICON_Y,ICON, ThemeColor.getHudColor());
        ...
        Fonts.prism_2.draw("S",x3 ,y + ICON_Y,ICON, ThemeColor.getHudColor());
