...
import ru.prism.utils.render.ItemRender;
...
public class TargetHud implements element {
    ...
    private final ru.prism.utils.animation.satoshi.Animation openAnimation = new EaseInOutQuad(200, 1);
    ...
    private void drawFace(LivingEntity lastTarget, float lastTickDelta, float x, float y, float alpha) {
        try {
            ...
            int color = ColorUtil.getColor(r, g, b, (int) (255 * alpha));
