...
import ru.prism.module.impl.render.Particles; // Импортируем наш модуль частиц
import ru.prism.module.impl.render.TotemGhost;
...
@ModuleInfo(
        name = "Fake Player",
        desc = "Ставит фейкового игрока для теста урона.",
