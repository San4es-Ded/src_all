...
public class Information implements element {
    ...
    public void onRender(DragSetting dragSetting, InterFace interFace) {
        ...
        Fonts.prism_2.draw("W",x + ICON_X,y + ICON_Y,ICON,ColorUtil.getClientColor(1));
        ...
        Fonts.prism_2.draw("H",x2 ,y + ICON_Y,ICON, ThemeColor.getHudColor());
        ...
        Fonts.prism_2.draw("V",x3 ,y + ICON_Y,ICON, ThemeColor.getHudColor());
