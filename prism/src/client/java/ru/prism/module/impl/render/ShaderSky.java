...
import ru.prism.utils.render.ShaderSkyRenderer;
import lombok.Getter;

@Getter
@ModuleInfo(name = "Shader Sky", category = Category.WORLD, desc = "Меняет небо на шейдерное с блюром, красиво до слёз.")
