...
import ru.prism.utils.render.GlassBlockRenderer;
...
@Getter
@ModuleInfo(name = "Glass Block", category = Category.VISUALS, desc = "Превращает блок под прицелом в стекло, читерский обзор.")
