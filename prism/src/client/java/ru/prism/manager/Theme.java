...
public enum Theme {
    /** Цвет выбирается самим пользователем; значение живёт в {@link GuiManager}. */
    CUSTOM("Custom",
            0xFF8BA2FF
    ...
    /** Дефолтный цвет пользовательской темы. */
    public static final int customColor = 0xFF8BA2FF;
