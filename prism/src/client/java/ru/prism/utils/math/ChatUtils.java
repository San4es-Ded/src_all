...
public class ChatUtils implements IMinecraft {
    ...
    public void addChatMessage(String text) {
        ...
        if (mc.inGameHud == null || mc.inGameHud.getChatHud() == null) {
            System.out.println("[Prism Logs] " + text);
            return;
        }

        Text message = Text.literal(    "").append(gradientText("PrismVisuals", new Color(ColorUtil.fade(90)),new Color(ColorUtil.fade(180)))).append(Text.literal(" » ").formatted(Formatting.GRAY)).append(Text.literal(text).formatted(Formatting.WHITE));
    ...
    public void addChatMessageDev(String text) {
        ...
        Text message = Text.literal(    "").append(gradientText("PrismVisuals [Dev]", new Color(ColorUtil.fade(90)),new Color(ColorUtil.fade(180)))).append(Text.literal(" » ").formatted(Formatting.GRAY)).append(Text.literal(text).formatted(Formatting.WHITE));
