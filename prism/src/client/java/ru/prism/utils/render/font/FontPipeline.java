package ru.prism.utils.render.font;
...
public class FontPipeline implements ru.prism.utils.render.DrawBatcher.Batched {
    ...
    public void drawText(FontAtlas atlas, String text, float x, float y, float size, int color,
        ...
        if (ru.prism.utils.render.DrawBatcher.isEnabled()) {
            ru.prism.utils.render.DrawBatcher.register(this);
        }
    ...
    private void sealChunk() {
        ...
        if (chunks.size() >= UNIFORM_RING - 1) {
            ru.prism.utils.render.DrawBatcher.drawImmediate(this, false);
        }
    ...
    public void flush() {
        sealChunk();
        if (!ru.prism.utils.render.DrawBatcher.isEnabled() && !chunks.isEmpty()) {
            ru.prism.utils.render.DrawBatcher.drawImmediate(this, false);
        }
    }
