    ...
    public static final void apply(@Nullable Framebuffer renderTarget, @NotNull float[] uniform) {
        ...
        try {
            ...
            try {
                ...
                data.position(0);
                encoder.writeToBuffer(currentUniform.slice(0L, 208L), data);
// stack = Unit.INSTANCE;
            }
            catch (Throwable bl) {
                throwable = bl;
            ...
            Supplier<String> supplier = GroundReflectRenderer::apply$lambda$1;
            ...
            try {
                ...
                renderPass.setUniform("ReflectParams", currentUniform);
                renderPass.draw(0, 6);
    ...
    private final boolean ensureSceneCopy(int width, int height) {
        ...
        this.closeTargets();
        GpuTexture gpuTexture = sceneCopyTexture = device.createTexture(GroundReflectRenderer::ensureSceneCopy$lambda$0, 5, TextureFormat.RGBA8, width, height, 1, 1);
        Intrinsics.checkNotNull((Object)gpuTexture);
        sceneCopyTextureView = device.createTextureView(gpuTexture);
        GpuTexture gpuTexture2 = depthCopyTexture = device.createTexture(GroundReflectRenderer::ensureSceneCopy$lambda$1, 5, TextureFormat.DEPTH32, width, height, 1, 1);
        Intrinsics.checkNotNull((Object)gpuTexture2);
