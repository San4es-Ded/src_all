...
implements SimpleGuiElementRenderState {
    ...
    public GlassOutlineRenderState(@NotNull Matrix3x2f pose, @NotNull BuiltGlassOutline outline, @Nullable ScreenRect scissorArea, @NotNull BlurCapture capture) {
    ...
    public void setupVertices(@NotNull VertexConsumer consumer) {
        ...
        int batchIndex = GlassOutlineBatch.INSTANCE.reserve(new GlassOutlineEntry(this.outline, this.capture));
        if (batchIndex < 0) {
            return;
        }
    ...
    public RenderPipeline pipeline() {
        return GlassOutlineBatch.PIPELINE;
    }
