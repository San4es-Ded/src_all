...
public class ConfigCreateDialog {
   private static final String TITLE = "Create config";
   ...
   private final TextInput t = new TextInput(TextInput.InputType.FILENAME, "", "Config name");
   ...
   private void a(Matrix3x2fStack MatrixStackVar, Renderer2D renderer2D, float f2, float f3, float f4, float f5, int i2) {
      ...
      fontRendererApply.a(
         CREATE,
         f2 + (f4 - fontRendererApply.a(CREATE)) / 2.0F,
         f3 + (f5 - fontRendererApply.b(CREATE)) / 2.0F + 3.5F,
         Theme.a(Theme.aa, i2),
         MatrixStackVar
      );
   }
