...
in vec4 shaderData;
out vec4 fragColor;
#define time (((shaderData.r*255.0*256.0+shaderData.g*255.0)/65535.0)*256.0)
#define alpha (shaderData.a)
#define baseColor vec4(0.72,0.42,1.0,1.0)
#define screenSize vec2(1.0)
