...
public class PyRotationMode extends AuraRotationMode {
   ...
   public PyRotationMode(ModeSetting localValue1, String localValue2, PyCallable localValue3, PyCallable localValue4, PyCallable localValue5, PyCallable localValue6, PyCallable localValue7) {
      ...
      this.owner = PythonScript.internalMethod00581();
   }
   ...
   public void rotate(RotationManager localValue1, float localValue2, boolean localValue3, boolean localValue4, RotationBehavior localValue5, LivingEntity localValue6) {
      if (this.rotateFn != null && !this.errored && EmbeddedPythonRuntime.internalMethod08724()) {
         try (AutoCloseable localValue7 = PythonScript.internalMethod02561(this.owner)) {
   ...
   public boolean canAttack() {
      if (this.canAttackFn != null && !this.errored && EmbeddedPythonRuntime.internalMethod08724()) {
         try {
            boolean localValue7;
            try (AutoCloseable localValue1 = PythonScript.internalMethod02561(this.owner)) {
   ...
   private void invoke(PyCallable localValue1, String localValue2) {
      if (localValue1 != null && !this.errored && EmbeddedPythonRuntime.internalMethod08724()) {
