...
public class DescendPathStep extends AbstractPathStep {
   ...
   public DescendPathStep(PathNode localValue1, PathNode localValue2) {
   ...
   private AbstractPathStep.InternalType0058 internalMethod00419() {
      MinecraftClient localValue1 = MinecraftClient.getInstance();
      ClientPlayerEntity localValue2 = localValue1.player;
      if (localValue2 == null) {
         return AbstractPathStep.InternalType0058.internalField1160;
