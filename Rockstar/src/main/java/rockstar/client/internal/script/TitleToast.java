...
extends ToastNotification {
    ...
    public final void internalMethod06653(CustomDrawContext customDrawContext, float f) {
        ...
        customDrawContext.drawIcon(this.internalField0432.internalMethod06848(), f4 + f6 / 2.0f - 4.5f, f5 + f6 / 2.0f - 4.5f, 10.0f, this.internalField0432.internalMethod04485().withAlpha((float)n * 0.8f));
