...
public final class TrackMatchScorer {
    ...
    public static double internalMethod03931(JsonObject jsonObject, String string, String string2, long l) {
        double d;
        boolean bl;
        String string3 = TrackMatchScorer.internalMethod01689(string2);
        String string4 = TrackMatchScorer.internalMethod01689(TrackMatchScorer.internalMethod06952(jsonObject, "trackName"));
        double d2 = TrackMatchScorer.internalMethod04266(string3, string4);
        ...
        if (!(!((d = TrackMatchScorer.internalMethod05208(string, TrackMatchScorer.internalMethod06952(jsonObject, "artistName"))) < 0.62) || d3 >= 0.0 && d3 <= 2.0)) {
            return Double.NEGATIVE_INFINITY;
        }
    ...
    public static double internalMethod05208(String string, String string2) {
        String string3 = TrackMatchScorer.internalMethod01689(string);
        String string4 = TrackMatchScorer.internalMethod01689(string2);
        ...
        Set<String> set = TrackMatchScorer.internalMethod05841(string);
        for (String string5 : TrackMatchScorer.internalMethod05841(string2)) {
            if (!set.contains(string5)) continue;
            return 1.0;
        }
        return TrackMatchScorer.internalMethod04266(string3, string4);
    }
