...
@FunctionalInterface
public interface OAuthTokenFlowProvider<T> {
    public OAuthTokenFlow internalMethod01631(RockstarHttpClient localValue1, OAuthClientConfig localValue2, T localValue3);
}
