...
public class SmoothCornerRectBatch
extends UiVertexBatch {
    private final ShaderProgramBase internalField0104 = RenderPipeline.internalMethod05294();
    private final float internalField0205;
    private final float internalField0206;

    public SmoothCornerRectBatch(float f) {
    ...
    public void internalMethod09053() {
        ...
        this.internalField0104.internalMethod05981("CornerSmoothness").set(this.internalField0206);
    ...
    public void internalMethod07440(Matrix4f matrix4f, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int n) {
