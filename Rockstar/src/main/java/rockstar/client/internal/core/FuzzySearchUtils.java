...
public final class FuzzySearchUtils {
    ...
    public static int internalMethod06845(String string, String string2) {
        return FuzzySearchUtils.internalMethod05951(FuzzySearchUtils.internalMethod00096(string), FuzzySearchUtils.internalMethod00096(string2));
    }
    ...
    public static int internalMethod05951(String string, String string2) {
        ...
        String string4 = FuzzySearchUtils.internalMethod01189(string);
        if (string4.equals(string3 = FuzzySearchUtils.internalMethod01189(string2))) {
            return 10;
        }
        ...
        int n2 = FuzzySearchUtils.internalMethod08295(string, string2);
        if (n2 >= 0) {
            return 80 + n2;
        }
        ...
        int n5 = FuzzySearchUtils.internalMethod08112(string, string2);
        ...
        int n8 = FuzzySearchUtils.internalMethod06979(string4, string3, n);
