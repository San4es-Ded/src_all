...
public class PaladinPotionSwapItem
extends AbstractAssistSwapItem {
    public PaladinPotionSwapItem() {
        super("modules.settings.assist.paladin_potion", Items.SPLASH_POTION.getDefaultStack(), AssistItemCategory.internalField1162);
    }
