...
public class AssassinPotionSwapItem
extends AbstractAssistSwapItem {
    public AssassinPotionSwapItem() {
        super("modules.settings.assist.assassin_potion", Items.SPLASH_POTION.getDefaultStack(), AssistItemCategory.internalField1162);
    }
