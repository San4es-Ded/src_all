...
public class CreateConfigDialog {
    ...
    private final TextInput t = new TextInput(TextInputType.FILENAME, "", "Имя конфига");
    ...
    public void a(MatrixStack matrixStack, ShapeRenderer s7swsm2, float f, float f2, int n, int n2) {
        ...
        float f11 = f9 + (f7 - v6hnga2.a("Создание конфига")) / 2.0f;
        float f12 = f10 + 3.0f * f6;
        v6hnga2.a("Создание конфига", f11, (double)(f12 + 5.0f), pryrvd.a(pryrvd.a, n3), matrixStack);
        float f13 = f9 + 12.0f * f6;
        float f14 = f12 + v6hnga2.b("Создание конфига") + 11.5f * f6;
    ...
    public boolean a(float f, float f2, int n, int n2) {
        ...
        FontRenderer v6hnga2 = ClientFonts.b[15];
        float f5 = f4 + 12.0f;
        float f6 = f3 + 3.0f + v6hnga2.b("Создание конфига") + 11.5f + 22.0f + 11.5f;
        float f7 = 73.75f;
