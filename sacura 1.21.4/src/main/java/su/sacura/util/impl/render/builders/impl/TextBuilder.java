 ...
 import su.sacura.util.impl.render.impl.BuiltText;
 ...
 public final class TextBuilder extends AbstractBuilder<BuiltText> {
   ...
   public TextBuilder font(FontRender fontRender) {
     this.font = fontRender.getFont();
     return this;
   }
   ...
   public TextBuilder outline(Color color, float thickness) {
     return outline(color.getRGB(), thickness);
   }
