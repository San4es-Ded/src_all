package wtf.wyvern.render.display.base.color;
...
public class ColorRGBA {
   ...
   public int getRGB() {
      // Every constructor already clamps all four channels. Packing the stored
      // integers directly is identical to the previous result and avoids four
      // float conversions, clamps and rounds for every rendered vertex.
