...
import wtf.wyvern.utility.game.other.MouseButton;
...
public class TextBox implements IMinecraft {
   ...
   public TextBox(Vector2f position, Font font, String emptyText, float width) {
      this.charFilter = CharFilter.ANY;
   ...
   public static enum CharFilter {
      ...
      private static CharFilter[] $values() {
         return new CharFilter[]{ANY, ENGLISH, ENGLISH_NUMBERS, CYRILLIC, NUMBERS_ONLY};
      }
   }
}