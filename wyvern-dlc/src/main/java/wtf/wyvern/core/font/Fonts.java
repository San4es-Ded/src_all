...
public final class Fonts {
    ...
    public static final MsdfFont ICONS5 = MsdfFont.builder().atlas("icons5").data("icons5").build();
    public static final MsdfFont NURIKI = MsdfFont.builder().atlas("nuriki").data("nuriki").build();
    public static final MsdfFont NURSULTANIK = MsdfFont.builder().atlas("nursultanik").data("nursultanik").build();
    public static final MsdfFont FONT = MsdfFont.builder().atlas("font").data("font").build();
    public static final MsdfFont LOGO = MsdfFont.builder().atlas("logo").data("logo").build();
    public static final MsdfFont ENERGY = MsdfFont.builder().atlas("energy").data("energy").build();
    public static final MsdfFont MINCED = MsdfFont.builder().atlas("iconsminced").data("iconsminced").build();
    public static final MsdfFont MAINMENU = MsdfFont.builder().atlas("iconpack1").data("iconpack1").build();
    ...
    public static final MsdfFont WYVERN = MsdfFont.builder().atlas("wyvern").data("wyvern").build();
