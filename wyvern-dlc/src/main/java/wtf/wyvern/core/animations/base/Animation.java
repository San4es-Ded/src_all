package wtf.wyvern.core.animations.base;
...
public class Animation {
   ...
   public float update(float newValue) {
      // Most UI animations spend almost all of their lifetime at a settled
      // value. Avoid reading the clock and evaluating easing curves for those
      // animations on every rendered frame.
      if (this.done && newValue == this.targetValue) {
         return this.value;
      }
