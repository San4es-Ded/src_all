...
public class ClickGuiThemeSelector {
    ...
    public void render(DrawContext context, Window window, ClickGuiState state, int categoryCount, float alphaMul) {
        ...
        customDrawContext.drawText(wtf.wyvern.core.font.Fonts.REGULAR.getFont(7.0f), "Theme", buttonX + 7.0f, buttonY + 4.0f, ColorRGBA.WHITE.withAlpha((int) (230 * alphaMul)));
        customDrawContext.drawText(wtf.wyvern.core.font.Fonts.REGULAR.getFont(7.0f), selected.getName(), buttonX + 42.0f, buttonY + 4.0f, ColorRGBA.WHITE.withAlpha((int) (205 * alphaMul)));
        customDrawContext.drawText(wtf.wyvern.core.font.Fonts.REGULAR.getFont(7.0f), arrow, buttonX + BUTTON_WIDTH - 10.0f, buttonY + 4.0f, ColorRGBA.WHITE.withAlpha((int) (210 * alphaMul)));
        ...
        for (int i = 0; i < themes.size(); i++) {
            ...
            customDrawContext.drawText(wtf.wyvern.core.font.Fonts.REGULAR.getFont(6.8f), theme.getName(), dropdownX + 17.0f, rowY + 3.0f, ColorRGBA.WHITE.withAlpha((int) (225 * alphaMul * dropdownProgress)));
        }
