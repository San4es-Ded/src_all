...
public class HitMarker extends Module {
    ...
    private final ModeSetting mode = new ModeSetting("Режим", "Cross 1", "Cross 2");
    private final SliderSetting size = new SliderSetting("Размер", 0.5f, 0.1f, 2.0f, 0.05f);
    private final SliderSetting fadeInTime = new SliderSetting("Время появления", 100f, 50f, 500f, 10f);
    private final SliderSetting displayTime = new SliderSetting("Время жизни", 300f, 100f, 1000f, 50f);
    private final SliderSetting fadeOutTime = new SliderSetting("Время исчезновения", 200f, 50f, 500f, 10f);
    ...
    private final ArrayList<HitMarkerData> renderMarkers = new ArrayList<>();
    ...
    private Identifier getTexture() {
        if (this.mode.is("Cross 2")) {
            return Identifier.of("wyvern", "icons/cross2.png");
        }
    ...
    public void onRender3D(EventRender3D e) {
        ...
        synchronized (hitMarkers) {
            renderMarkers.clear();
            renderMarkers.addAll(hitMarkers);
        }
        ...
        for (HitMarkerData marker : renderMarkers) {
