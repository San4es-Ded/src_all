...
public class SliderSetting extends Setting {
   ...
   public SliderSetting(String name, float value, float min, float max, float increment, Test edit) {
      super(name);
      this.min = min;
      this.max = max;
      this.current = value;
   ...
   public SliderSetting(String name, float value, float min, float max, float increment, String description) {
      super(name);
      this.min = min;
      this.max = max;
      this.current = value;
