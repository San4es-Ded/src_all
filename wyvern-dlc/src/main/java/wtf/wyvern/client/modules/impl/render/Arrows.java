...
public class Arrows extends Module {
    ...
    private final SliderSetting radius = new SliderSetting("Радиус", 50, 50, 300, 5);
    private final SliderSetting size = new SliderSetting("Размер", 15, 5, 25, 1);
    ...
    private void onRenderHud(EventHudRender event) {
        ...
        for (PlayerEntity entity : RenderFrameCache.players()) {
            ...
            appendArrow(matrices, buffer, themeColor.withAlpha((int) (alpha * 255)), size.getCurrent());
