package wtf.wyvern.client.ui.interfaces.draggable;
    ...
    private Align determineAlign(float x, float y, float screenWidth, float screenHeight) {
        ...
        if (top) {
            if (left) {
                ...
                return centerX ? Align.TOP_CENTER : Align.TOP_RIGHT;
            }
        } else if (centerY) {
            if (left) {
                return Align.CENTER_LEFT;
            } else {
                return centerX ? Align.CENTER : Align.CENTER_RIGHT;
            }
        } else if (left) {
            return Align.BOTTOM_LEFT;
        } else {
            return centerX ? Align.BOTTOM_CENTER : Align.BOTTOM_RIGHT;
        }
    }
