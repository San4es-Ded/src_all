...
public class SimulatedPlayer implements IClient {
   ...
   public static SimulatedPlayer simulateLocalPlayer(int ticks) {
      SimulatedPlayer simulatedPlayer = fromClientPlayer(SimulatedPlayerInput.fromClientPlayer(mc.player.input.playerInput));
   ...
   public static SimulatedPlayer simulateOtherPlayer(PlayerEntity player, int ticks) {
      SimulatedPlayer simulatedPlayer = fromOtherPlayer(player, SimulatedPlayerInput.guessInput(player));
