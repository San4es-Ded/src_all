...
void main() {
    ...
    // подъём усиливается к верху кадра — шлейф «всплывает»
    ...
    // Never wrap the previous frame around screen edges; that produced long
    // diagonal shards when the hand moved quickly.
